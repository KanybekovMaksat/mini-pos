...
import { Settings as SettingsIcon, User, Shield, Bell, Store, Moon, Sun } from 'lucide-react';
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">Управление системой и настройками</p>
      </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={mockPoints.find(p => p.id === user?.pointId)?.name || ''}
                disabled
                className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                value={mockPoints.find(p => p.id === user?.pointId)?.address || ''}
                disabled
                className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50"
              />
            </div>
        ...
        {canManageSettings && (
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Роли и доступ</h2>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-4 border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-red-100 text-red-700 px-2 py-1 rounded-full">Полный доступ</span>
                </div>
                <p className="text-sm text-gray-600">
                  Управление товарами, отчётами, сотрудниками, историей и аналитикой
                </p>
              </div>
              ...
              <div className="p-4 border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full">Ограниченный</span>
                </div>
                <p className="text-sm text-gray-600">
              ...
              <div className="p-4 border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">Полный доступ</span>
                </div>
                <p className="text-sm text-gray-600">
                  Полный доступ ко всем данным и возможность подключить Telegram
                </p>
              </div>
            </div>
          </div>
